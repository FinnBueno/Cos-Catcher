...
export const nl: Localization = {
    auth: {
        error: {
            emailAlreadyInUse: 'Deze e-mail is al in gebruik',
            passwordMinimum: 'Je wachtwoord moet minimaal uit %{count} tekens bestaan',
            emailValid: 'Dat is geen geldige e-mail',
            usernameMinimum: 'Je username moet minimaal uit %{count} tekens bestaan',
        },
        welcome: 'Welkom!',
